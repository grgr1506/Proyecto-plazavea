/**
 * Clase M_Venta - Modelo de datos de Venta
...
class M_Venta {
  ...
  constructor(idventa = 0, fecha = null, hora = '', serie = '', num_documento = '',
              tipo_documento = '', subtotal = 0, igv = 0, total = 0,
              estado = '', idusuario = 0, idcliente = '') {
  ...
  set idcliente(v)      { this.#idcliente = v; }
}
