class M_Compra {
  #idcompra; #fecha; #hora; #num_documento; #tipo_documento; #subtotal; #igv; #total; #estado; #idusuario; #idproveedor;
  get idcompra()       { return this.#idcompra; }       set idcompra(v)       { this.#idcompra = v; }
