...
class N_Cliente extends BaseDAO {
  ...
  async insertar(dts) {
    await this.ejecutar('CALL sp_guardar_cliente($1, $2, $3, $4, $5, $6, $7, $8, $9)',
      [dts.codigo, dts.apellidos, dts.nombres, dts.dni, dts.ruc, dts.edad, dts.sexo, dts.telefono, dts.direccion]);
    return true;
  }
  ...
  async eliminar(dts) {
    await this.ejecutar('CALL sp_eliminar_cliente($1)', [dts.codigo]);
    return true;
  }
}
